...
1. **VAST.AI Mining - vast.ai (verified)**:
   ...
   For single GPU use vast.sh:
      ```
   sudo apt update && sudo apt -y install wget && sudo wget https://raw.githubusercontent.com/GFSalvato/xgpunew/main/vast.sh && sudo chmod +x vast.sh && sudo ./vast.sh
      ```

   For 2 X GPU use vast2.sh:
      ```
   sudo apt update && sudo apt -y install wget && sudo wget https://raw.githubusercontent.com/GFSalvato/xgpunew/main/vast2.sh && sudo chmod +x vast2.sh && sudo ./vast2.sh
      ```      

   For 4 X GPU use vast4.sh:
      ```
   sudo apt update && sudo apt -y install wget && sudo wget https://raw.githubusercontent.com/GFSalvato/xgpunew/main/vast4.sh && sudo chmod +x vast4.sh && sudo ./vast4.sh
      ```      
