...
1. **VAST.AI Mining - vast.ai (verified)**:
   ...
   For 2 X GPU use vast2.sh:
      ```
   sudo apt update && sudo apt -y install wget && sudo wget https://raw.githubusercontent.com/GFSalvato/xgpunew/edit/main/vast2.sh && sudo chmod +x vast2.sh && sudo ./vast2.sh
      ```      
